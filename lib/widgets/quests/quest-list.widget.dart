...
class _QuestListWidgetState extends State<QuestListWidget> {
  ...
  Widget makeListBuilder(context, List<Quest> data) => ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        if (index - 1 == -1) {
          var item = Quest();
          item.name = AppLocalizations.of(context)?.unlockQuest ?? "Unlock Quest by watching ad";
                  ...
                  children:
                    <Widget> [
                      Text(AppLocalizations.of(context)?.reward ?? "Rewards",
                          overflow: TextOverflow.ellipsis, maxLines: 1, style: Theme.of(context).textTheme.titleMedium),
