import 'package:Talkaboat/utils/color.dart';
import 'package:flutter/material.dart';

class NewDefaultColors {
  NewDefaultColors._();

  static const primaryColorBase = Color.fromRGBO(100, 164, 253, 1);

  static final primaryColor = MaterialColor(primaryColorBase.value, const <int, Color>{
  ...
  static final primaryColorAlphaBlend = MaterialColor(primaryColorBase.value, const <int, Color>{
  ...
  static final secondaryColor = MaterialColor(primaryColorBase.value, const <int, Color>{
  ...
  static final secondaryColorAlphaBlend = createMaterialColor(const Color.fromRGBO(29, 40, 58, 0.97));
  static final secondaryColorAlphaBlendStrong = MaterialColor(primaryColorBase.value, const <int, Color>{
